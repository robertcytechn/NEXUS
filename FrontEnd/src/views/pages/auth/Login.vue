...
// Configuración de colores para asegurar que el Login use el tema Cyan/Slate
const primaryColors = {
            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    <div class="text-center mb-8">
                        ...
                        <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">Core Nexus Manager</div>
                    ...
                    <div>
                        ...
                        <Password id="password" name="password" v-model="password" placeholder="Contraseña" :toggleMask="true" class="mb-4" fluid :feedback="false" autocomplete="current-password"></Password>
                        ...
                        <div class="mt-6 text-center">
                            <p class="text-sm text-surface-600 dark:text-surface-400">
                                ...
                                <router-link 
                                    to="/lisencia" 
                                    class="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 font-semibold underline decoration-primary-600 dark:decoration-primary-400 hover:decoration-primary-700 dark:hover:decoration-primary-300 transition-colors"
                                >
                                    Términos y Condiciones
                                </router-link>
                            </p>
