...
<template>
    <div class="flex flex-col gap-6">
        ...
        >
            <form id="recompensa-mc-form" @submit.prevent="guardarRecompensa">
        ...
        <Dialog v-model:visible="dialogEntrega" modal :style="{ width: '460px' }" header="✅ Confirmar Entrega de Canje">
            <form id="entrega-mc-form" @submit.prevent="confirmarEntrega" class="flex flex-col gap-4">
            ...
            <template #footer>
                ...
                <Button type="submit" form="entrega-mc-form" label="Confirmar Entrega" icon="pi pi-check" severity="success" :loading="loadingEntrega" />
            </template>
        </Dialog>
    </div>
</template>
